...
@section('content')
    <main class="container min-h-screen py-20">
        ...
        <h1 class="text-bruma-orange mb-8 text-center text-xl uppercase">Accesibilidad</h1>
        <div class="space-y-4">
            <p>La presente declaración de accesibilidad se aplica al sitio web https://https://brumarestaurant.com/:</p>
